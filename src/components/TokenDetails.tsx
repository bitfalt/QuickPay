    ...
    <View style={styles.container}>
      ...
      <View style={styles.totalBalanceCard}>
        ...
        <Text style={styles.totalAmount}>
          {formatTokenAmount(tokenData.totalBalance, tokenData.symbol as AssetTickerValue)}
        </Text>
                ...
                <View key={`${item.network}-${index}`} style={styles.networkRow}>
                  <View style={styles.networkInfo}>
                    <View style={[styles.networkIcon, { backgroundColor: networkColor }]}>
                      <Image source={networkConfigs[item.network]?.icon} style={styles.tokenIconImage} />
                    </View>
                  ...
                  <View style={styles.networkBalance}>
                    <Text style={styles.networkAmount}>
                      {formatTokenAmount(item.balance, tokenData.symbol as AssetTickerValue)}
                    </Text>
