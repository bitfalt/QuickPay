...
import { AssetTicker } from '@/lib/wdk-native';
import type { AssetTickerValue } from '@/lib/wdk-native';
...
class PricingService {
  ...
  private fiatExchangeRateCache: Record<FiatCurrency, Record<AssetTickerValue, number>> | undefined;
  ...
  getExchangeRate(asset: AssetTickerValue, currency: FiatCurrency): number | undefined {
